<?php
	...
	$content='<form class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Middle Name" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Telephone" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="radio">
													<label>
														<input name="form-field-radio2" type="radio" class="ace" checked />
									...
									<div class="form-group">
										...
										<div class="radio">
													<label>
														<input name="form-field-radio3" type="radio" class="ace" checked />
														<span class="lbl"> Current</span>
													</label>
													<label>
														<input name="form-field-radio3" type="radio" class="ace" />
